...
<form action="index.php?page=admin" method="post"
    ...
    <button type="submit" class="btn btn-danger" name="btn_country_del">Удалить страну</button>
    <br>
...
<form id="hotel-adding-form" enctype="multipart/form-data" action="index.php?page=admin" method="post"
    ...
    <button type="submit" class="btn btn-danger" name="btn_state_del">Удалить город</button>
    <br>
    ...
    <br>
    <label>Картинки:</label><input id="add-images" accept="image/*" type="file" name="image[]" multiple><br>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for(let i = 0; i < result.length - 1; i++) {
                        $('#image-container').append("<img src='data:image/png;base64," + result[i] +"'>");
                    }
                },
                error: function() {
                }
